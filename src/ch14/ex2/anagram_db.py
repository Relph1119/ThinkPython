...
from ch12.ex2.anagram_sets import all_anagrams, signature
...
def main(script, command='make_db'):
    if command == 'make_db':
        anagram_map = all_anagrams(os.path.dirname(sys.path[2]) + os.sep + "resource"+ os.sep +"words.txt")
        store_anagrams(os.path.dirname(sys.path[2]) + os.sep + "resource"+ os.sep +"anagrams.db", anagram_map)
    else:
        print(read_anagrams(os.path.dirname(sys.path[2]) + os.sep + "resource"+ os.sep +"anagrams.db", command))
